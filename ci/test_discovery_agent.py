...
class TestDiscoveryAgent:
  ...
  def __init__(self, tradefed_args: list[str], test_mapping_zip_path: str, tradefed_jar_revelant_files_path: str = "../../../tools/tradefederation/prebuilts/filegroups/tradefed/"):
