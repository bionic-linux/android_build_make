...
class MetricsAgent:
  ...
  def end_reporting(self):
    ...
    with open(os.path.join(os.environ['DIST_DIR'], self._SOONG_METRICS_PATH), 'rb') as f:
    ...
    with open(os.path.join(os.environ['DIST_DIR'], self._SOONG_METRICS_PATH), 'wb') as f:
