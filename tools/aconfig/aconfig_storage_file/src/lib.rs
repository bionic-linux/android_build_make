...
mod tests {
    ...
    fn test_list_flag() {
        let package_table =
            write_bytes_to_temp_file(&create_test_package_table(DEFAULT_FILE_VERSION).into_bytes()).unwrap();
        let flag_table = write_bytes_to_temp_file(&create_test_flag_table(DEFAULT_FILE_VERSION).into_bytes()).unwrap();
        let flag_value_list =
            write_bytes_to_temp_file(&create_test_flag_value_list(DEFAULT_FILE_VERSION).into_bytes()).unwrap();
    ...
    fn test_list_flag_with_info() {
        ...
        let flag_value_list =
            write_bytes_to_temp_file(&create_test_flag_value_list(DEFAULT_FILE_VERSION).into_bytes()).unwrap();
        let flag_info_list =
            write_bytes_to_temp_file(&create_test_flag_info_list(DEFAULT_FILE_VERSION).into_bytes()).unwrap();
