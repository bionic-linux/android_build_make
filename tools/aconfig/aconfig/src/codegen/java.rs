    ...
    fn test_generate_java_code_exported() {
        ...
        public final class FeatureFlagsImpl implements FeatureFlags {
            ...
            private void init() {
                ...
                int val;
                try {
                    aPackage = new AconfigPackage("com.android.aconfig.test");
                    val = aPackage.getBooleanFlagValue("disabled_rw_exported");
                    disabledRwExported = val == AconfigPackage.FLAG_BOOLEAN_VALUE_NOT_EXIST ? disabledRwExported : val == AconfigPackage.FLAG_BOOLEAN_VALUE_TRUE;
                    val = aPackage.getBooleanFlagValue("enabled_fixed_ro_exported");
                    enabledFixedRoExported = val == AconfigPackage.FLAG_BOOLEAN_VALUE_NOT_EXIST ? enabledFixedRoExported : val == AconfigPackage.FLAG_BOOLEAN_VALUE_TRUE;
                    val = aPackage.getBooleanFlagValue("enabled_ro_exported");
                    enabledRoExported = val == AconfigPackage.FLAG_BOOLEAN_VALUE_NOT_EXIST ? enabledRoExported : val == AconfigPackage.FLAG_BOOLEAN_VALUE_TRUE;
                } catch (Exception e) {
                    throw new AconfigStorageException("Cannot read flag in codegen", e);
                }
                isCached = true;
