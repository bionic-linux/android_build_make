...
public class HostDeviceProtos {
    /**
     * An iterface that executes ADB command and return the result.
     */
    ...
    private static final String RECURSIVELY_LIST_APEX_DIR_COMMAND = "ls -R /apex";
    private static final String APEX_ACONFIG_PATH_SUFFIX = "/etc/aconfig_flags.pb";


    /**
     * Returns the list of all on-device aconfig protos paths from host side.
     * @hide
     */
