...
def AddImagesToTargetFiles(filename):
  ...
  if OPTIONS.info_dict.get("avb_enable") == "true":
    ...
    if vbmeta_system and any(m in partitions for m in vbmeta_system.split()):
    ...
    if vbmeta_vendor and any(m in partitions for m in vbmeta_vendor.split()):
    ...
    if OPTIONS.info_dict.get("avb_building_vbmeta_image") == "true" and any(m in partitions for m in vbmeta_partitions):
      banner("vbmeta")
