...
$(call add_json_map, PartitionVarsForSoongMigrationOnlyDoNotUse)
  ...
  $(call add_json_list, BoardInfoFiles, $(if $(TARGET_BOARD_INFO_FILES),$(TARGET_BOARD_INFO_FILES),$(firstword $(TARGET_BOARD_INFO_FILE) $(TARGET_DEVICE_DIR)/board-info.txt)))
