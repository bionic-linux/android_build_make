...
$(call add_json_map, PartitionVarsForSoongMigrationOnlyDoNotUse)
  ...
  $(call add_json_list, BoardSuperPartitionPartitionList, $(BOARD_SUPER_PARTITION_PARTITION_LIST))
  $(call add_json_list, BoardSuperPartitionGroups, $(BOARD_SUPER_PARTITION_GROUPS))
  $(call add_json_map, BoardSuperPartitionGroupsInfo)
  ...
  $(call add_json_str, LpMakeDir, $(dir $(LPMAKE)))
