...
$(call add_json_str,  BuildFingerprintFile,              $(PRODUCT_OUT)/build_fingerprint.txt)
$(call add_json_str,  BuildNumberFile,                   $(SOONG_OUT_DIR)/build_number.txt)
$(call add_json_str,  BuildHostnameFile,                 $(SOONG_OUT_DIR)/build_hostname.txt)
$(call add_json_str,  BuildThumbprintFile,               $(PRODUCT_OUT)/build_thumbprint.txt)
