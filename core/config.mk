...
TARGET_AOSP_SYSFS_UDC ?= true
ifneq ($(TARGET_AOSP_SYSFS_UDC),true)
  ifeq ($(call math_gt_or_eq,$(BOARD_API_LEVEL),202504),true)
    $(error Devices with board API level $(BOARD_API_LEVEL) must set TARGET_AOSP_SYSFS_UDC to true)
  endif
endif
