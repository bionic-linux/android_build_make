...
# Filter shared entries between general-tests and host-unit-tests's SYMLINKS.FILES,
...
my_symlinks_for_general_tests := $(foreach f,$(my_symlinks_for_general_tests_files),\
