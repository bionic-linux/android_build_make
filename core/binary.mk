...
ifneq ($(LOCAL_SDK_VERSION),)
  ...
  ifeq (system,$(LOCAL_NDK_STL_VARIANT))
    ...
    my_clang_arch := $(call target_arch_to_clang_arch,$(TARGET_$(LOCAL_2ND_ARCH_VAR_PREFIX)ARCH))
    my_libcxx_arch_dir := $(my_llvm_dir)/android_libc++/ndk/$(my_clang_arch)
    ...
    my_ndk_stl_static_lib += libunwind
    my_ldlibs += -ldl
