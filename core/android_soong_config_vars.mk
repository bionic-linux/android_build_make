...
# Add strict_lineage flag for selecting GoogleServiceFramework lineage type.
$(call soong_config_set_bool,gsf,strict_lineage,$(if $(filter true,$(RELEASE_PACKAGE_GSF_STRICT_LINEAGE)),true,false))
