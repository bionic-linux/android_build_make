...
# TODO(b/381317459): Once the issue with `select` syntax handling `string_list` in Soong is fixed, set the default value in the original Android.bp.
$(call soong_config_set_string_list, recovery, target_recovery_ui_lib, $(if $(strip $(TARGET_RECOVERY_UI_LIB)),$(TARGET_RECOVERY_UI_LIB),librecovery_ui_default))
