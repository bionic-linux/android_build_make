...
$(call soong_config_set, recovery, target_userimages_use_f2fs, $(TARGET_USERIMAGES_USE_F2FS))
$(call soong_config_set_bool, recovery ,board_cacheimage_partition_size ,$(if $(BOARD_CACHEIMAGE_PARTITION_SIZE),true,false))
